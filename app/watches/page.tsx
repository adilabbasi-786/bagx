...
function WatchesPage() {
  const products = mockProducts.filter((p) => p.category === 'watches')
      ...
      <main className="flex-1">
        ...
        <div className="bg-secondary/50 px-4 py-8">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl font-playfair font-bold text-foreground mb-2">Luxury Watches</h1>
              ...
              <div className="bg-secondary/30 p-6 rounded-lg space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {['Gold', 'Rose Gold', 'Silver', 'Black'].map((color) => (
