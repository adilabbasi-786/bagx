...
function CosmeticsPage() {
  const products = mockProducts.filter((p) => p.category === 'cosmetics')
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-secondary/30 p-6 rounded-lg space-y-6">
                ...
                {/* Type Filter */}
                <div>
                  <h3 className="font-semibold text-foreground mb-3">Product Type</h3>
                  <div className="space-y-2">
                    {['Lipstick', 'Foundation', 'Eyeshadow', 'Serum'].map((type) => (
